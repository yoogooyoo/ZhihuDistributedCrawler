...
class ZhihuSpider(scrapy.Spider):
    ...
    def parse_answer(self, response):
        ...
        for answer in ans_json["data"]:
            ...
            answer_item["likes_num"] = answer["voteup_count"]
    ...
    def start_requests(self):
        return [scrapy.FormRequest('https://www.zhihu.com/#signin', headers=self.headers, callback=self.login)]
    ...
    def login(self, response):
        ...
        if xsrf:
            ...
            post_data = {
                "_xsrf": xsrf,
                "email": "lambertyoo@163.com",
                "password": "YooHoo201314",
                "captcha": ""
            }
